...
Auto line counts starts at 50k and doubles the line count until the frame time is above 8ms. **Note: Using auto lines counts can result in flashing colors as meshes spawn/despawn.**
